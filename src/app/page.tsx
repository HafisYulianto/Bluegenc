  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-500 selection:text-white bg-white text-slate-900 overflow-x-hidden">
      ...
      <main>
        ...
        {/* B2. About Section - White Clean */}
        <section id="tentang" className="relative py-24 px-4 md:px-8 bg-white">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10 border-t border-slate-100 pt-20"
          >
            {/* Left side text */}
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand-200 bg-brand-50 text-brand-600 text-sm font-semibold mb-6 shadow-sm">
                <Sparkles className="w-4 h-4" /> {t.about.badge}
              </div>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#0d2047] mb-6 leading-tight">
                {t.about.title1}<span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-500 to-brand-700">{t.about.titleHighlight}</span><br />{t.about.title2}
              </h2>
            </div>

            {/* Right side narrative */}
            <div className="flex-1 bg-[#f8faff] border border-slate-200 p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden group shadow-xl shadow-slate-100 hover:border-brand-300 transition-colors duration-500">
              <div className="absolute top-0 right-0 w-64 h-64 bg-brand-50 rounded-full blur-[80px] group-hover:bg-brand-100 transition-colors duration-700 pointer-events-none"></div>
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-6 relative z-10 font-medium">
                {t.about.desc1}
              </p>
              <p className="text-base md:text-lg text-slate-500 leading-relaxed relative z-10">
                {t.about.desc2}
              </p>
            </div>
          </motion.div>
        ...
        {/* C. Services Section - Light Blue-White Bento Grid */}
        <section id="layanan" className="relative py-32 px-4 md:px-8 bg-[#f0f5ff] border-t border-slate-100">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              <div className="max-w-2xl">
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-[#0d2047] mb-6">
                  {t.services.title}
                </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
              ...
              {/* Feature 1 - Navy Card */}
              <div className="lg:row-span-2 bg-[#0d2047] p-8 md:p-10 rounded-[2rem] border border-[#1a3a6e] relative overflow-hidden group hover:border-brand-500/70 transition-colors duration-500">
                <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-brand-500/20 rounded-full blur-[80px] group-hover:bg-brand-400/30 transition-colors duration-700 pointer-events-none"></div>
                <div className="relative z-10 flex flex-col h-full justify-between">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    <span className="px-3 py-1.5 rounded-full bg-white/10 border border-white/10 text-white text-xs font-medium">{t.services.s1_tag1}</span>
                    <span className="px-3 py-1.5 rounded-full bg-white/10 border border-white/10 text-white text-xs font-medium">{t.services.s1_tag2}</span>
                  </div>
                </div>
              </div>

              {/* Feature 2 - White Card */}
              <div className="bg-white p-8 md:p-10 rounded-[2rem] border border-slate-200 group hover:border-brand-400 hover:shadow-lg hover:shadow-brand-100 transition-all duration-500 flex flex-col justify-between">
                <div>
                  <Globe className="w-8 h-8 md:w-10 md:h-10 text-brand-500 mb-5" />
                  <h3 className="text-xl md:text-2xl font-bold text-[#0d2047] mb-2">{t.services.s2_title}</h3>
                  <p className="text-slate-500 text-sm md:text-base">{t.services.s2_desc}</p>
                </div>
              </div>

              {/* Feature 3 - Blue Gradient (keep as brand accent) */}
              <div className="bg-gradient-to-br from-brand-500 to-brand-700 p-8 md:p-10 rounded-[2rem] border border-brand-400/50 group hover:border-brand-300 transition-colors duration-500 flex flex-col justify-between overflow-hidden relative">
                <div className="absolute -right-4 -top-4 opacity-10 pointer-events-none">
                  <Cpu className="w-32 h-32 md:w-40 md:h-40" />
                </div>
                <div className="relative z-10">
                  <Zap className="w-8 h-8 md:w-10 md:h-10 text-brand-100 mb-5" />
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-2">{t.services.s3_title}</h3>
                  <p className="text-brand-100/80 text-sm md:text-base">{t.services.s3_desc}</p>
                </div>
              </div>
        ...
        {/* D. Featured Portfolio Section - Navy Gallery */}
        <section id="portofolio" className="py-32 px-4 md:px-8 bg-[#0d2047] relative border-y border-white/10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
        ...
        {/* E. Team Section - Navy */}
        <section id="tim" className="py-32 px-4 md:px-8 bg-[#0d2047] relative border-t border-white/10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
              ...
              {teams.map((member) => (
                <div key={member.id} className="w-full max-w-[320px] sm:max-w-none sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-2rem)] xl:w-[calc(20%-2rem)] group relative rounded-3xl overflow-hidden bg-[#0d1e36] border border-white/5 hover:border-brand-500/50 transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_30px_60px_rgba(11,132,235,0.2)]">
                  ...
                  <div className="relative aspect-[4/5] w-full overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0d2047] via-[#0d2047]/80 to-transparent opacity-90 z-10 h-full pointer-events-none"></div>
                  </div>
        ...
        {/* F. Workflow Section - White Clean Stepper */}
        <section id="cara-kerja" className="relative py-32 px-4 md:px-8 bg-white border-t border-slate-100">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-[#0d2047] text-center mb-20">
              {t.workflow.title}
            </h2>
            ...
            <div className="mt-8 md:mt-24 max-w-3xl mx-auto h-[200px] md:h-40">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-[#f0f5ff] border border-brand-100 rounded-3xl p-6 md:p-8 text-center shadow-lg shadow-brand-100/50"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-[#0d2047] mb-3 md:mb-4">{t.workflow.steps[activeWorkflowStep].title}</h3>
        ...
        {/* F. Contact Section - Navy Glass Card */}
        <section id="kontak" className="bg-[#0d2047] relative py-32 px-4 md:px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="max-w-6xl mx-auto bg-gradient-to-br from-[#122a5e] to-[#0d2047] rounded-[3rem] shadow-[0_30px_100px_-15px_rgba(37,99,235,0.25)] overflow-hidden flex flex-col lg:flex-row relative z-20 border border-white/10"
          >
      ...
      <section className="py-20 md:py-32 border-t border-slate-100 bg-white relative flex flex-col items-center px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-[#0d2047] mb-16">
            {t.partners.title}
          </h2>
